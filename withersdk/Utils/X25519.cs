...
namespace withersdk.Utils
{
    public static class X25519
    {
        ...
        /// <summary>
        /// Фиксация закрытого ключа (встроенная, для повышения производительности)
        /// </summary>
        /// <param name="key">[out] 32 случайных байта</param>
        ...
        /// <summary>
        /// Фиксация закрытого ключа
        /// </summary>
        /// <param name="rawKey">[out] 32 рандомных байта</param>
        ...
        /// <summary>
        /// Создает случайный закрытый ключ
        /// </summary>
        /// <returns>32 случайных байта, которые привязаны к подходящему закрытому ключу</returns>
        ...
        /// <summary>
        /// Генератор ключ-пары (встроенный, для производительности)
        /// </summary>
        /// <param name="publicKey">[out] открытый ключ</param>
        /// <param name="signingKey">[out] ключ подписи (игнорируется, если NULL)</param>
        /// <param name="privateKey">[out] закрытый ключ</param>
        /// <remarks>ПРЕДУПРЕЖДЕНИЕ: если ключ подписи не равен NULL, время выполнения этой функции зависит от данных</remarks>
        ...
        /// <summary>
        /// Генерирует открытый ключ из сохраненного закрытого ключа
        /// </summary>
        /// <param name="privateKey">закрытый ключ (Сначала необходимо вызвать ClampPrivateKey!)</param>
        ...
        /// <summary>
        /// Генерирует ключ подписи из сохраненного закрытого ключа
        /// </summary>
        /// <param name="privateKey">private key (Сначала необходимо вызвать ClampPrivateKey!)</param>
        ...
        /// Ключевое соглашение
        /// </summary>
        /// <param name="privateKey">[in] ваш личный ключ для соглашения о ключе</param>
        /// <param name="peerPublicKey">[in] открытый ключ однорангового узла</param>
        /// <returns>общий секрет-ключ (нуждается в стирке перед использованием)</returns>
